...
#define STRING_CONFIG_H_AUTHOR "(Maeve Baksa - Oct 09.2021)" // Who made the changes.
...
#define BAUDRATE_2 25000   // Enable to override BAUDRATE
...
#define CUSTOM_MACHINE_NAME "HE3d K280 - 4in1out"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 610.0             // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 441 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *
 * See https://github.com/synthetos/TinyG/wiki/Je/rk-Controlled-Motion-Explained
 */
